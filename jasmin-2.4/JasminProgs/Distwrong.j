...
.method public static dist(DD)D
 ...
 ;load the first int argument, it is a double so it is still signed when we multiply it, and multiply it with itself 
dload 0 
dload 0
dmul
;load the second argument, and multiply it with itself 
dload 2
dload 2
dmul 
